...
"""autogenerated by genpy from ibvs/DetectionResult.msg. Do not edit."""
import codecs
import sys
...
class DetectionResult(genpy.Message):
  _md5sum = "4e77c3858d67058b1a7e3b743cd831cb"
  _type = "ibvs/DetectionResult"
...
float64 Z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.Z,) = _get_struct_d().unpack(str[start:end])
      return self
